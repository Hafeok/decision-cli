...
pub const IRI_DEC_CONFORMANCE_AUDIT_CLASS: &str = "https://decision-cli.dev/ns#ConformanceAudit";

/// IRI prefix for minted ConformanceAudit artifacts:
/// `https://decision-cli.dev/ns/conformance-audit/<id>`.
pub const IRI_DEC_CONFORMANCE_AUDIT_PREFIX: &str = "https://decision-cli.dev/ns/conformance-audit/";
