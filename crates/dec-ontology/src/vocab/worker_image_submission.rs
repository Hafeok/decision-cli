...
pub const IRI_DEC_CLAIMED_BUILD_RUN_URL: &str = "https://decision-cli.dev/ns#claimed_build_run_url";
...
pub const IRI_DEC_PRODUCED_WORKERIMAGE: &str = "https://decision-cli.dev/ns#produced_workerimage";
