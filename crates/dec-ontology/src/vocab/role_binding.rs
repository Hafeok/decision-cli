...
pub const IRI_DEC_DEFAULT_CAPABILITY: &str = "https://decision-cli.dev/ns#default_capability";

/// `dec:escalation_steps` predicate — RoleBinding → rdf:List of EscalationStep.
pub const IRI_DEC_ESCALATION_STEPS: &str = "https://decision-cli.dev/ns#escalation_steps";
...
pub const TRIGGER_FEEDBACK_UNIMPLEMENTABLE_CRITICAL: &str = "feedback_unimplementable_critical";
