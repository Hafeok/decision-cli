...
mod tests {
    ...
    fn to_quads_emits_required_triples() {
        ...
        assert!(quads
            .iter()
            .any(|q| q.predicate.as_str() == crate::vocab::IRI_DEC_WAIVER_FOR));
        assert!(quads
            .iter()
            .any(|q| q.predicate.as_str() == crate::vocab::IRI_DEC_WAIVER_REASON));
        assert!(quads
            .iter()
            .any(|q| q.predicate.as_str() == crate::vocab::IRI_DEC_UNCOVERED_AT_WAIVE));
    }
