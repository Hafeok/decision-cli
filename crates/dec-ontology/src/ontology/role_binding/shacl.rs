...
use crate::vocab::{
    ...
    IRI_DEC_STEP_CAPABILITY, IRI_DEC_TRIGGERS, IRI_DEC_TRIGGER_SIGNAL, TRIGGER_SIGNAL_VOCABULARY,
};
...
fn check_binding_role_id(quads: &[Quad], subject: &NamedNode, v: &mut Vec<RoleBindingViolation>) {
...
fn check_binding_active(quads: &[Quad], subject: &NamedNode, v: &mut Vec<RoleBindingViolation>) {
...
fn check_binding_version(quads: &[Quad], subject: &NamedNode, v: &mut Vec<RoleBindingViolation>) {
