...
use crate::vocab::{
    ...
    worker_image_id_pred, worker_image_name_pred, worker_image_version_pred, ELIGIBILITY_CANDIDATE,
    ELIGIBILITY_DEPRECATED, ELIGIBILITY_PULLED, ELIGIBILITY_QUALIFIED, IRI_DEC_WORKER_IMAGE_PREFIX,
};
