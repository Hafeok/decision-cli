...
use crate::vocab::IRI_DEC_ALLOWED_OPS;
...
fn term_matches_subject(s: &oxrdf::Subject, t: &Term) -> bool {
    match (s, t) {
        (oxrdf::Subject::NamedNode(a), Term::NamedNode(b)) => a == b,
        (oxrdf::Subject::BlankNode(a), Term::BlankNode(b)) => a == b,
        _ => false,
    }
}
