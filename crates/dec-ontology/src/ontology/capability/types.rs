...
use crate::vocab::{
    ...
    capability_version_pred, configurable_effort_pred, context_window_pred,
    cost_cache_hit_per_m_pred, cost_cache_write_5m_pred, cost_currency_pred, cost_input_per_m_pred,
    cost_output_per_m_pred, exposes_reasoning_trace_pred, max_output_pred, model_identifier_pred,
    supports_tool_calling_pred, supports_vision_pred, tier_pred, CAPABILITY_STATUS_ACTIVE,
    CAPABILITY_STATUS_CANDIDATE, CAPABILITY_STATUS_EOL, CAPABILITY_STATUS_PREVIEW, CURRENCY_EUR,
    CURRENCY_USD, ENDPOINT_ANTHROPIC, ENDPOINT_SCALEWAY, IRI_DEC_CAPABILITY_PREFIX,
};
