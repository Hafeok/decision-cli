...
use crate::verify::safety::SafetyViolation;
...
pub enum Error {
    ...
    /// [`crate::verify::safety::SafetyViolation`].
...
impl From<crate::verify::safety::SafetyError> for Error {
    fn from(value: crate::verify::safety::SafetyError) -> Self {
        use crate::verify::safety::SafetyError;
        match value {
