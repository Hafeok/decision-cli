...
fn load_any_capability(store: &Store, iri: &NamedNode) -> Option<Capability> {
    use dec_graph::ontology::capability::types::{CapabilityStatus, CostCurrency, Endpoint};
