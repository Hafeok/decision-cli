...
use crate::dispatch::{resume_check, ResumeError, ResumeOutcome};
...
/// time by `dec init` (the binary's init slice).
...
mod tests {
    ...
    use super::*;
    use crate::dispatch::{pause_on_feedback, DispatchGroup};
    use dec_graph::stream_writer::StreamWriter;
    use dec_ontology::vocab::{feedback_class, in_stream, lifecycle_state, orchestration_graph};
