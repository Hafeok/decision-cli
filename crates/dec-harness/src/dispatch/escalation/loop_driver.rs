...
use crate::dispatch::caching::{should_cache, split_bundle_for_caching, CacheableBlock};
use crate::dispatch::capability_resolver::{resolve_default_capability, ResolvedCapability};
use dec_graph::bundle::Bundle;
use dec_graph::ontology::capability::{query_by_iri, CapabilityStatus};
use dec_graph::ontology::role_binding::active_for_role;
use dec_graph::StreamWriter;
...
struct LoopState {
    ...
    prior_reason: Option<dec_graph::ontology::role_binding::TriggerSignal>,
}
...
impl LoopState {
    ...
    fn advance(
        ...
        reason: Option<dec_graph::ontology::role_binding::TriggerSignal>,
