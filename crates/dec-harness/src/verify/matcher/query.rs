...
//! [`crate::verify::coverage::feature_covered_by`] one graph at
...
use dec_ontology::vocab::IRI_DEC_GRAPH_VERIFY_GRAPH;
...
fn short_id_of(graph_iri: &str) -> &str {
    graph_iri
        .strip_prefix(dec_ontology::vocab::IRI_DEC_VERIFY_GRAPH_PREFIX)
        .unwrap_or(graph_iri)
}
