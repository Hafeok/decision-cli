...
use crate::verify::GRAPH_FAULT_EXIT_CODES;
use dec_graph::ontology::verdict::Verdict;
use dec_graph::ontology::verification_graph::{StepKind, VerificationGraph};
...
fn build_evidence_body(
    _kind: dec_graph::ontology::verification_graph::StepKind,
    trace: &StepRunTrace,
    step_index: usize,
) -> String {
