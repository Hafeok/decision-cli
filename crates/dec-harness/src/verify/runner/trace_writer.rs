...
use dec_graph::ontology::verification_bench::VerificationBench;
use dec_graph::ontology::verification_graph::VerificationGraph;
use dec_graph::ontology::verification_result::{
...
use dec_ontology::vocab::{verify_result_graph, IRI_DEC_VERIFY_RESULT_PREFIX};
...
pub(crate) fn write_result(
    ...
    use crate::verify::stale_defects::retract_stale_defects_in_transaction;
    let _closed_count =
