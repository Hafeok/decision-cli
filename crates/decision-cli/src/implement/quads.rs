//! Quad builders for Session, Dispatch, and completion mutations.
...
use super::vocab::{
    ...
    DEC_MODEL_VERSION, DEC_OUTPUT_REF, DEC_ROLE_PROP, DEC_STATUS_PROP, PROV_ACTIVITY,
    PROV_AT_TIME, PROV_ENDED_AT_TIME, PROV_GENERATED_BY, PROV_USED, RDF_TYPE,
};
