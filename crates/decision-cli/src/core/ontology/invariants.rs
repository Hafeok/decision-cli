//! Parse-time SHACL / ontology invariant checks for the embedded bundle.
//! Generic loading and hashing helpers live in the sibling `helpers.rs`.

use oxigraph::sparql::QueryResults;
use oxigraph::store::Store;

use super::{
    OntologyError, BOUNDARY_ARTIFACT_CLASS, BOUNDARY_ARTIFACT_SHAPE, BOUNDARY_ARTIFACT_SUBCLASSES,
    EXTERNAL_ORIGIN_PROP, IS_MIGRATION_BACKFILL_PROP, MECHANICAL_PROVENANCE_SHAPE,
    MIGRATION_BACKFILL, MIGRATION_BACKFILL_SHAPE, MOTIVATIONAL_PREDICATES, ONTOLOGY_GRAPH_IRI,
    PROV_WAS_DERIVED_FROM, SESSION_PROVENANCE_SHAPE, SHAPES_GRAPH_IRI,
};
