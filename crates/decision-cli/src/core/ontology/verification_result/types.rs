...
use crate::core::vocab::{
    IRI_DEC_VERIFY_RESULT_PREFIX, OUTCOME_FAIL, OUTCOME_PASS, OUTCOME_UNRUNNABLE,
};
...
pub(super) const PROV_WAS_ATTRIBUTED_TO: &str = "http://www.w3.org/ns/prov#wasAttributedTo";
pub(super) const DCTERMS_CREATED: &str = "http://purl.org/dc/terms/created";
