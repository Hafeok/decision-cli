...
use crate::core::vocab::{
    ...
    namespace_pred, ontology_body, ontology_description_class, ontology_version_pred,
    pattern_name, prefix_pred, IRI_DEC_CR_PREFIX, IRI_DEC_EX_PREFIX, IRI_DEC_OD_PREFIX,
...
pub(super) const SUPERSEDES: &str = "https://decision-cli.dev/ns#supersedes";
pub(super) const SUPERSEDED_BY: &str = "https://decision-cli.dev/ns#supersededBy";
...
impl CapabilityReference {
    ...
    pub fn to_quads(&self) -> Vec<Quad> {
        ...
        let mut quads = vec![
            ...
            literal_quad(&subject, capability_version_cr(), &self.capability_version, &g),
...
impl OntologyDescription {
    ...
    pub fn to_quads(&self) -> Vec<Quad> {
        ...
        let mut quads = vec![
            ...
            literal_quad(&subject, ontology_version_pred(), &self.ontology_version, &g),
...
impl ExemplarGraph {
    ...
    #[must_use]
    pub fn to_quads(&self) -> Vec<Quad> {
        use crate::core::vocab::rationale;
        let g: GraphName = catalog_graph().into_owned().into();
        let subject = self.iri();
        let mut quads = vec![
