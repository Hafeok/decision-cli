...
use crate::core::vocab::{
    IRI_PROV_GENERATED_AT_TIME, IRI_PROV_WAS_ATTRIBUTED_TO_MECHANICAL as IRI_PROV_WAS_ATTRIBUTED_TO,
...
fn typed_literal_values(
    ...
    quads
        ...
        .filter_map(|q| {
            ...
            match &q.object {
                Term::Literal(lit) => Some((lit.value().to_string(), lit.datatype().as_str().to_string())),
                _ => None,
            }
        })
        .collect()
