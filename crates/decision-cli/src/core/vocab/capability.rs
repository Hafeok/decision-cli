...
pub const IRI_DEC_SUPPORTS_TOOL_CALLING: &str =
...
pub const IRI_DEC_COST_CACHE_HIT_PER_M: &str =
    "https://decision-cli.dev/ns#cost_cache_hit_per_m";
/// `dec:cost_cache_write_5m` predicate — cost per 1M cache-write input tokens.
pub const IRI_DEC_COST_CACHE_WRITE_5M: &str =
    "https://decision-cli.dev/ns#cost_cache_write_5m";
