...
pub const IRI_DEC_CAPABILITY_REFERENCE: &str =
    "https://decision-cli.dev/ns#CapabilityReference";

/// `dec:OntologyDescription` — declarative description of the dec
/// namespace, classes, and canonical predicates.
pub const IRI_DEC_ONTOLOGY_DESCRIPTION: &str =
    "https://decision-cli.dev/ns#OntologyDescription";
...
pub const IRI_DEC_CAPABILITY_VERSION_CR: &str =
    "https://decision-cli.dev/ns#capabilityVersion";
...
pub const IRI_DEC_ONTOLOGY_VERSION: &str =
    "https://decision-cli.dev/ns#ontologyVersion";
...
// that constant via `crate::core::vocab::IRI_DEC_SUPERSEDED_BY`.
