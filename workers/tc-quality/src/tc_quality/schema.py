"""Structured-output response schema for tc-quality verdicts."""

from __future__ import annotations


def build_verdict_response_schema() -> dict:
    """Return the JSON schema for QualityVerdict structured output (ADR-074, FT-127).
    ...
    return {
        ...
        "properties": {
            ...
            "judges": {
                "type": "string",
                "description": "IRI of the TcProposal artifact under judgment.",
            },
            "against": {
                "type": "array",
                "items": {"type": "string"},
                "minItems": 1,
                "description": "Source-of-truth IRIs (feature_spec for TC quality).",
            },
            "violates": {
                "type": "array",
                "items": {"type": "string"},
