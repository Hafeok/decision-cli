"""Typed builder for dec:Acknowledgement artifacts."""
...
class AcknowledgementBuilder(BuilderBase):
    """Builder for emitting dec:Acknowledgement artifacts.
    ...
    TARGET_CLASS_LOCAL: str = 'Acknowledgement'
    SOURCE_SHAPE: str = 'workers/_shared/shapes/acknowledgement.ttl'
    ...
    def add_motivatedBy(self, target_iri: str) -> "AcknowledgementBuilder":
