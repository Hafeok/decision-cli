"""Typed builder for dec:WorkerImage artifacts."""
...
class WorkerImageBuilder(BuilderBase):
    """Builder for emitting dec:WorkerImage artifacts.
    ...
    TARGET_CLASS_LOCAL: str = 'WorkerImage'
    SOURCE_SHAPE: str = 'workers/_shared/shapes/worker-image.ttl'
    ...
    def add_addresses(self, target_iri: str) -> "WorkerImageBuilder":
    ...
    def add_decomposesFrom(self, target_iri: str) -> "WorkerImageBuilder":
