...
class ConformanceAuditBuilder(BuilderBase):
    ...
    TARGET_CLASS_LOCAL: str = 'ConformanceAudit'
    SOURCE_SHAPE: str = 'workers/_shared/shapes/conformance-audit.ttl'
    ACCEPTS_BOUNDARY: bool = True
    MOTIVATIONAL: tuple[MotivationalDescriptor, ...] = (
        MotivationalDescriptor(
            predicate_local='audits',
            predicate_iri='https://decision-cli.dev/ns#audits',
            target_class_local='WorkerImage',
