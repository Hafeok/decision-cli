"""Typed builder for dec:WorkerImageSubmission artifacts."""
...
class WorkerImageSubmissionBuilder(BuilderBase):
    """Builder for emitting dec:WorkerImageSubmission artifacts.
    ...
    TARGET_CLASS_LOCAL: str = 'WorkerImageSubmission'
    SOURCE_SHAPE: str = 'workers/_shared/shapes/worker-image-submission.ttl'
