"""Typed builder for dec:Policy artifacts."""
...
class PolicyBuilder(BuilderBase):
    """Builder for emitting dec:Policy artifacts.
    ...
    TARGET_CLASS_LOCAL: str = 'Policy'
    SOURCE_SHAPE: str = 'workers/_shared/shapes/policy.ttl'
    ...
    def add_addresses(self, target_iri: str) -> "PolicyBuilder":
    ...
    def add_decomposesFrom(self, target_iri: str) -> "PolicyBuilder":
