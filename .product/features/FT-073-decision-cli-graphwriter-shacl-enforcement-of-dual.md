...
domains-acknowledged:
  ...
  error-handling: SHACL violations surface as Error::SchemaViolation through the StreamWriter chokepoint (FT-001 / ADR-041). The error-handling shape is inherited from that boundary rather than authored per feature.
