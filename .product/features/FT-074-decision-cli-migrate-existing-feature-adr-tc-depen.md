...
domains-acknowledged:
  ...
  error-handling: Migration errors follow ADR-042's grandfather-with-backfill policy; FT-074 inherits that error model rather than introducing a separate error-handling design.
